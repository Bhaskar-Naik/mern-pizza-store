...
const deleteUser = asyncHandler(async (req, res) => {
  const SUPER_ADMIN_EMAIL = 'baachin22@gmail.com';

  // 1. Check if the logged-in user is the super admin
  if (req.user.email !== SUPER_ADMIN_EMAIL) {
    res.status(403);
    throw new Error('Access denied. Only the Super Admin can delete users.');
  }
  ...
  // 2. Prevent super admin from deleting themselves
